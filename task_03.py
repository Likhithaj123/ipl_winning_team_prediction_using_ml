...
Original file is located at
    https://colab.research.google.com/drive/1MXquvKbLF_rd_i6tjvvT-md6irslpA2s
"""
...
print(delivery_df.dtypes)
print(delivery_df['player_dismissed'].unique())
print(delivery_df['player_dismissed'].head())
# Convert non-dismissals to 0, dismissals to 1
delivery_df['player_dismissed'] = delivery_df['player_dismissed'].apply(lambda x: 0 if x == "0" else 1)

# Explicitly set the column type to integer
delivery_df['player_dismissed'] = delivery_df['player_dismissed'].astype(int)
